...
{start:}
	...
	{nalichie:}, <span style="font-size:100%" class="label {Наличие на складе=:В наличии?:label-primary?(Наличие на складе=:Распродажа?:label-success?(Наличие на складе=:На заказ?:label-info?:label-default))}">{Наличие на складе}</span>{market?:market}
{market:}
